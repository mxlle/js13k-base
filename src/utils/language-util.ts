...
export function getLanguagesWithoutDefault(languages: string[], defaultLanguage = getDefaultLanguage()) {
  return languages.filter((lang) => lang !== defaultLanguage);
}

export function getLanguageForGame(languages: string[], useNonDefaultLanguage = false) {
